...
mysettings = xbmcaddon.Addon(id = 'plugin.video.tvhaingoai')
...
def add_dir(name, url, mode, iconimage, fanart):
	...
	if 'Redirect2ChromeLauncher' in url:
		u = 'plugin://plugin.program.chrome.launcher/?kiosk=no&mode=showSite&stopPlayback=no&url=http%3A%2F%2Fwww.viettv24.com%2Fmain%2F%3Flanguage%3Dvi'
	if 'RedirectToVietTV24free' in url:
		u = 'plugin://plugin.video.viettv24free'
